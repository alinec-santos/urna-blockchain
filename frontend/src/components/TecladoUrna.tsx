  ...
  return (
    <div className="teclado-urna">
      ...
      <div className="acoes-teclado">
        <button className="btn-teclado btn-branco" onClick={onBranco}>
          BRANCO
        </button>
        <button className="btn-teclado btn-corrige" onClick={onCorrige}>
          CORRIGE
        </button>
        <button className="btn-teclado btn-confirma" onClick={onConfirma}>
          CONFIRMA
        </button>
      </div>
    </div>
